...
public class LoginController {
        ...
        try (Connection conn = ConexionDB.getConection()) {
            ...
            if (rs.next()) {
                ...
                abrirVentana(rol.equalsIgnoreCase("Administrador")
                        ? "/com/example/proyectoprogra/dashboard-admin.fxml"
                        : "/com/example/proyectoprogra/dashboard-cliente.fxml");
    ...
    private void abrirRegistro() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/proyectoprogra/register-view.fxml"));
    ...
    private void abrirRecuperacionDePin(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/proyectoprogra/recuperacion-pin-view.fxml"));
            Parent root = loader.load();
            Stage dialog = new Stage();
            dialog.initModality(Modality.APPLICATION_MODAL);
